...
const ShopHeader = ({ sellerInfo }) => {
    ...
    return (
        <div className='relative'>
            <Image className='w-full h-36 rounded-lg' src={cover} alt='banner' quality={100} height={500} width={500} />
            <div className='bg-[#ffffffc7] absolute top-5 left-5 bottom-5 rounded-lg p-2 flex items-center gap-5'>
                <Image className='rounded-full h-16 md:h-20 w-16 md:w-20' src={avatar} alt={name} quality={100} height={500} width={1200} />
